...
/* package collector-0.1.0.0 */
#ifndef VERSION_collector
#define VERSION_collector "0.1.0.0"
#endif /* VERSION_collector */
#ifndef MIN_VERSION_collector
#define MIN_VERSION_collector(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_collector */
...
/* package language-python-0.5.8 */
#ifndef VERSION_language_python
#define VERSION_language_python "0.5.8"
...
#define CURRENT_COMPONENT_ID "collector-0.1.0.0-inplace-collector"
